...
let Greeting: Dialog[] = [
    {
      name: 'greeting',
      text: 'Heey! My name is Cristie. I am a fashion model in the Jomsy world!',
    },
      ...
      buttons: [
        {
          ...
          triggeredActions: () => {
            robot.followPath({
              path: [robotOriginalPosition, new Vector3(8, 0, 6)],
              loop: false,
              totalDuration: 4,
              curve: true,
              startingPoint: 0,
...

  {
    ...
    triggeredByNext: () => {
      robot.followPath({
        ...
        curve: true,
        startingPoint: 0,
        path: [new Vector3(8, 0, 6), robotOriginalPosition],
      })
    }
  },
  ...
  {
    name: 'book intro',
    text: 'Jomsy Book is not done yet.. But it will soon be right here',
    triggeredByNext: () => {
      robot.followPath({
        loop: false,
        totalDuration: 4,
